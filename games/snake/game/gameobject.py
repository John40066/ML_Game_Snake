...
class SnakeBody(Sprite):
    def __init__(self, init_pos, color):
        ...
        draw.line(self.image, (0, 0, 0), (width - 1, 0),
                  (width - 1, height - 1))
        draw.line(self.image, (0, 0, 0), (0, height - 1),
                  (width - 1, height - 1))
...
class Snake:
    def __init__(self):
        self.head = SnakeBody((150, 150), (31, 204, 42))  # Green

        self.body = deque()
        self.body_color = (255, 255, 255)   # White
        # Note the ordering of appending elements
        self.body.append(SnakeBody((150, 140), self.body_color))
        self.body.append(SnakeBody((150, 130), self.body_color))
        self.body.append(SnakeBody((150, 120), self.body_color))
